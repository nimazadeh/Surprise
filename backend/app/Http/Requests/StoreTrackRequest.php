...
class StoreTrackRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', 'alpha_dash', 'unique:tracks,slug'],
            ...
            'status' => ['required', 'string', 'in:'.implode(',', [Track::STATUS_DRAFT, Track::STATUS_PUBLISHED, Track::STATUS_ARCHIVED])],
